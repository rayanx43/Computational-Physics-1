...
#Potential within a rectangular region: the Jacobi with a grid size = 1
...
V[1:-1,1:-1] = 0.00 # naive guess which gives 504 iterations
#1.80 gives us 401 iterations
#1.90 gives us 370 iterations
